...
function ChatScreen() {
  ...
  function LoadingProgress() {
    return (
      <div id="loadingProgress" className="flex flex-col gap-2 justify-center">
        <p id="loadingProgressText" className="text-primary"></p>
        <progress
          id="loadingProgressBar"
          className="hidden progress progress-primary w-56"
          max="100"
        ></progress>
      </div>
    );
